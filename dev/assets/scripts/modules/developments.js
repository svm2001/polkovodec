export default function developments() {
  ...
  if(window.innerWidth < 1280) {
    ...
    items.forEach(item => {
      const titleHeight = item.querySelector('.developments__list-item-title').scrollHeight
      const btnHeight = item.querySelector('.developments__list-item-trigger').scrollHeight
      const shadow = item.querySelector('.developments__list-item-content-shadow')
